...
function Menu() {
  ...
  return (
    <main className="menu">
      ...
      {numPizzas > 0 ? (
        <>
          <p>Authentic (maybe not!) Italian cuisine.</p>
        ...
        <p>
          We are still working on our menu for today. Please come back later.
        </p>
      )}
    </main>
  );
...
function Order({ openHour, closedHour }) {
  return (
    <div className="order">
      <p>
        We are open from {openHour}:00 to {closedHour}:00. Come visit us or
        order online!
      </p>
